...
{
    [Header("Components")]
    [SerializeField] private ComputeGrassPainter grassAllocator = default;
    ...
    private void OnValidate()
    {
        ...
        grassAllocator = GetComponent<ComputeGrassPainter>();
    ...
    private void OnEnable()
    {
        ...
        if (grassAllocator == null || sourceMesh == null || computeShader == null || material == null)
        {
            return;
        }
    ...
    private void OnDrawGizmos()
    {
        if (interactor != null)
        {
            ...
            Gizmos.DrawWireSphere(interactor.transform.position, affectRadius);
        }
    }
}